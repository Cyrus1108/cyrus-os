...
function toggleTR(id){const i=S.tr.list.find(i=>i.id===id);if(i){i.d=!i.d;if(window.Sfx){i.d?Sfx.tick():Sfx.untick();}}saveTR();rTR();rMetrics();if(typeof rpgAfterChange==='function')rpgAfterChange();}
