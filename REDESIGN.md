...
状态:**P0 完成(v7.32.0-.2)· P1 完成(v7.33.0)· P2 完成(v7.34.0)· P3 完成
(v7.35.0:君主徽记 WebGL 场景 + energyflow 三层深度分层)**。待办:P3 diff 的正式
审查补跑(额度墙,总监督已亲审 crest.js 放行)、P4 HUD 逐个精修、P5 真机压测(用户)。
定稿日 2026-07-05。
